...
public class Song {
	...
	@Id	
	@GeneratedValue(strategy = GenerationType.IDENTITY)//tell it to increment by 1 every time it titles an ID
	private Long id;
...
//	private Title title;//song title

	@Column(updatable = false)//can't update the createdAt field
	...
	//do this before anything is entered into the DB
	@PrePersist
